...
return [
    ...
    'security' => [
        ...
        */
        'api_key_security' => [ // Unique name of security
            ...
            'description' => 'User API Token generated at register',
            'name' => 'X-API-TOKEN', // The name of the header or query parameter to be used.
    ...
    */
     ...
     */
    'constants' => [
         'API_HOST' => env('APP_ENV') === 'production' ? 'http://user-rest-php.vercel.app/' : 'http://test.local/',
    ],
];
